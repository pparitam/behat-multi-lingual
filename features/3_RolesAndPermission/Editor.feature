...
Feature: Validate Role wise Permissions
  ...
  Scenario: Login with Editor User and check basic permissions
    Given I am on "/"
    Given I login as "Editor" user
    ...
    And I should have access of "/en/node/9/delete"
    And I should have access of "/en/node/9/revisions"
    And I should have access of "/en/node/9/edit"
